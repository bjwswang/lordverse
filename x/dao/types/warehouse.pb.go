...
func (m *Warehouse) GetVoters() string {
	if m != nil {
		return m.Voters
	}
	return ""
...
func (m *Warehouse) GetThreshold() string {
	if m != nil {
		return m.Threshold
	}
	return ""
...
func (m *Warehouse) GetActive() string {
	if m != nil {
		return m.Active
	}
	return ""
...
var fileDescriptor_60ee7425da28d03f = []byte{
	...
	,
}
...
func (m *Warehouse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Active) > 0 {
		...
		i = encodeVarintWarehouse(dAtA, i, uint64(len(m.Active)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Threshold) > 0 {
		...
		i = encodeVarintWarehouse(dAtA, i, uint64(len(m.Threshold)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Voters) > 0 {
		...
		i = encodeVarintWarehouse(dAtA, i, uint64(len(m.Voters)))
		i--
		dAtA[i] = 0x12
	}
	if m.Id != 0 {
