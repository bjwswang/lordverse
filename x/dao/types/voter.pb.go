...
var fileDescriptor_5be75f71b79165ab = []byte{
	...
	0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x85, 0x4b, 0xe9, 0xa5, 0x24, 0xe6, 0x2b, 0x59, 0x72,
	0xb1, 0x86, 0x81, 0x64, 0x85, 0x24, 0xb8, 0xd8, 0x13, 0x53, 0x52, 0x8a, 0x52, 0x8b, 0x8b, 0x25,
	0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0x60, 0x5c, 0x21, 0x31, 0x2e, 0xb6, 0xf2, 0xd4, 0xcc, 0xf4,
	0x8c, 0x12, 0x09, 0x26, 0xb0, 0x04, 0x94, 0xe7, 0xa4, 0x7f, 0xe2, 0x91, 0x1c, 0xe3, 0x85, 0x47,
	0x72, 0x8c, 0x0f, 0x1e, 0xc9, 0x31, 0x4e, 0x78, 0x2c, 0xc7, 0x70, 0xe1, 0xb1, 0x1c, 0xc3, 0x8d,
	0xc7, 0x72, 0x0c, 0x51, 0xa2, 0x08, 0xeb, 0x2b, 0xc0, 0x0e, 0x28, 0xa9, 0x2c, 0x48, 0x2d, 0x4e,
	0x62, 0x03, 0xbb, 0xc0, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xa6, 0xe4, 0x60, 0xa8, 0x9e, 0x00,
	0x00, 0x00,
}
...
func (m *Voter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Weight) > 0 {
		...
		i = encodeVarintVoter(dAtA, i, uint64(len(m.Weight)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Address) > 0 {
