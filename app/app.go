...
import (
	...
	appparams "lordverse/app/params"
	"lordverse/docs"
)
...
func New(
	...
	*/
	...
	app.LordverseKeeper = *lordversemodulekeeper.NewKeeper(
		appCodec,
		keys[lordversemoduletypes.StoreKey],
		keys[lordversemoduletypes.MemStoreKey],
		app.GetSubspace(lordversemoduletypes.ModuleName),
